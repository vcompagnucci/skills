...
- **Agents solve the "process completion problem".** Regulated work needs actions across several systems as well as information. The agent coordinates and drafts, and "the analyst makes the final decision". (`finance-agents`, `healthcare-agents`)
